        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item active">
              <a class="nav-link" href="#" style="color:#000000; font-weight:800">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#" style="color:#000000; font-weight:800">Minhas viagens</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#" style="color:#000000; font-weight:800">Blog</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#" style="color:#000000; font-weight:800">Cadastre-se</a>
            </li>
            <li class="nav-item">
...
<div class="container ">
  <div class="row second-nav my-5 rowSegundaNav">
    ...
    <!-- Fim da div vazia para espaçamento -->
    	...
    	<div class="col-2"><a href='dicas-uteis.jsp' class='navOption'>
      		<span class="underline-green flexItemNav greenClr p-2 rounded text-black">Dicas Úteis</span> </a>
    	</div>
  ...
  <div class="container">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="#" style="color:#2020ff">Brasil</a></li>
        <li class="breadcrumb-item"><a href="#" style="color:#2020ff">Sao Paulo</a></li>
        <li class="breadcrumb-item active" aria-current="page" style="color:#000000">Dicas Úteis</li>
      </ol>
    </nav>
  </div>
  ...
  <div class="Camila">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <a class="dicas btn btn-info" href="#quandoIr" role="button">Quando Ir</a>

          <a class="dicas btn btn-info" href="#temperaturaMediaAnual" role="button">Temperatura média anual</a>
  
          <a class="dicas btn btn-info" href="#fusoHorario" role="button">Fuso horário</a>
  
          <a class="dicas btn btn-info" href="#tempoMedio" role="button">Tempo médio de permanência</a>
  
          <a class="dicas btn btn-info" href="#idioma" role="button">Idioma</a>
  
          <a class="dicas btn btn-info" href="#voltagemTomada" role="button">Voltagem e tipo de tomada</a>

          <a class="dicas btn btn-info" href="#moeda" role="button">Moeda</a>

          <a class="dicas btn btn-info" href="#documentosNecessarios" role="button">Documentos necessários</a>
  
          <a class="dicas btn btn-info" href="#bagagem" role="button">Bagagem</a>
  
          <a class="dicas btn btn-info" href="#comoSeLocomover" role="button">Como se locomover</a>          
      ...
      <div class="row">
        <div class="container col-lg-8 mapa">
          ...
          <iframe class="shadow-sm rounded-lg mapDiv"
            ...
            title="Mapa da cidade de São Paulo pelo Google Maps"
            ></iframe>
        </div>
          ...
          <div class="card card text-center rounded-lg shadow-sm card-come">
            <span class="card-body">
              ...
              <div class="d-flex justify-content-center flex-column">
                <h4 class="card-text  text-small">Tarifa do metrô</h5>
                <p>R$ XX,XX</p>
              </div>
    ...
    <section id="quandoIr" class="quandoIr mt-5">
      <div class="container">        
        ...
        <div class="row">
          <div class="col-lg-8 order-1 order-lg-2">
            <img src="img/dicas/quando-ir.jpg" class="img-fluid" alt="Foto aérea de São Paulo">
          </div>
          <div class="col-lg-4 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <p>O clima de São Paulo é considerado tropical úmido e as estações não são tão marcadas como em outras regiões do Brasil. No inverno podemos ter dias muito quentes e no verão podemos ter dias frescos.</p>
            <br><p>A temperatura durante o ano pode variar entre 15°C e 36°C e poucas vezes ela muda bruscamente, como com passagens de frente fria que podem fazer a temperatura cair mais de 10 graus de um dia para o outro. Então dá para vir em qualquer época do ano.</p>
            <br><p>Em São Paulo capital não tem alta ou baixa temporada, nem mudanças grandes nos preços, pois funciona como cidade de negócios e não depende somente do turismo. Quando preços sobem, é mais a questão da inflação no Brasil mesmo. Inclusive, aqui é muito interessante para fazer compras. Claro que para se hospedar ou chegar de avião, é bom se planejar com antecedência para aproveitar os melhores preços.</p>
          </div>
        </div>
      </div>
    </section>   
     ...
     <section id="temperaturaMediaAnual" class="temperaturaMediaAnual">
      <div class="container">        
        ...
        <div class="row">
          <div class="col-lg-8 order-1 order-lg-2">
            <img src="img/dicas/temperatura-media.jpg" class="img-fluid" alt="Foto aérea de São Paulo">
          </div>
          <div class="col-lg-4 pt-4 pt-lg-0 order-2 order-lg-1 content">
           <p>O clima da cidade de São Paulo é considerado subtropical úmido (Cfa de acordo com a classificação climática de Köppen-Geiger), com as quatro estações do ano relativamente definidas. A temperatura média anual é de 20 °C; o verão é morno com precipitação e o inverno é fresco com pouca precipitação. Ao longo do ano, normalmente, a temperatura mínima nos meses mais frios é de 12 °C e a temperatura máxima nos meses mais quentes é de 28 °C e raramente são inferiores a 7 °C ou superiores a 32 °C.</p>
              <br><p>Em São Paulo, as temperaturas são aumentadas principalmente pelo efeito das ilhas de calor, que são ocasionadas pela poluição atmosférica, poucas áreas verdes e a alta concentração de edifícios</p>
              <br><p>É no Mirante de Santana, na zona norte, onde fica a estação oficial da cidade, administrada pelo Instituto Nacional de Meteorologia (INMET) e em operação desde 1945, doze anos depois da estação do IAG/USP.</p>
          </div>
        </div>
      </div>
    </section>   
    ...
    <section id="fusoHorario" class="fusoHorario">
      <div class="container">
        <div class="section-title">
              <h2>Fuso horário</h2> </div>
        <div class="row">
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
          
              <p>O Brasil observa quatro fusos horários: o Horário de Fernando de Noronha (FNT – Fernando de Noronha Time em UTC-02:00); o Horário de Brasília (BRT – Brasília Time em UTC-03:00); o Horário da Amazônia (AMT – Amazon Time em UTC-04:00); o Horário do Acre (ACT – Acre Time em UTC-05:00).</p>
              <br><p>A padronização dos horários foi introduzida em 1.º de janeiro de 1914, após publicação do DPL 2.784, de 18 de junho e do decreto 10.546, de 5 de novembro de 1913; antes, cada lugar sincronizava os relógios conforme o horário solar aparente. Havia uma diferença horária de c. de 13 minutos e 54 segundos da então capital federal (até 1960) Rio de Janeiro (c. UTC-02:52:41) a São Paulo (c. UTC-03:06:35) como exemplo, esta que deixou de existir com o estabelecimento do atual Horário de Brasília a ambas capitais e estados homônimos.</p>
              <br><p>Em 2010, surgiu uma proposta para mudar todo o país para uma única diferença com o UTC±00:00, tendo o Horário de Brasília como base,[22] mas tal proposta foi desconsiderada.</p>
           
          </div>
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="img/dicas/fuso-horario.jpg" class="img-fluid" alt="Imagem aérea do por do sol na Avenida Paulista">
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="tempoMedio" class="tempoMedio">
      <div class="container">
        <div class="section-title">
              <h2>Tempo médio de permanência</h2></div>
        <div class="row">
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
          
              <p>O tempo médio de permanência pode variar conforme objetivo, negócios ou passeio</p>
              <br><p>Alguns dos passeios mais interessantes da cidade estão no Centro: a Pinacoteca do Estado, o Museu da Língua Portuguesa e o Mercado Municipal podem ser combinados numa mesma saída. Vale a pena contemplar o espigão da Avenida Paulista de dois mirantes opostos: o Terraço Itália e o hotel Unique.</p>
              <br><p>As experiências de compras vão de A a Z – dos shoppings mais sofisticados às ruas especializadas em pechinchas, como José Paulino, 25 de Março e Santa Ifigênia.</p>
              <br><p>O eixo Itaim-Jardins tem mais restaurantes, mas Higienópolis é uma opção central e paulistaníssima. Na vida noturna, a rivalidade Vila Madalena x Vila Olímpia ganhou um concorrente: o Baixo Augusta, o preferido dos alternativos.</p>
              <br><p>Independente do objetivo da sua viagem tente ficar mais alguns dias para conheçer melhor a cidade.</p>
          
          </div>
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="img/dicas/embarque.jpg" class="img-fluid" alt="Foto do interior do aeroporto">
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="idioma" class="idioma">
      <div class="container">        
        ...
        <div class="row">
          <div class="col-lg-8 order-1 order-lg-2">
            <img src="img/dicas/idioma-3.jpeg" class="img-fluid" alt="Foto de várias pessoas em um restaurantes ao céu aberto de noite. Ao fundo se vê uma a paisagem de uma cidade">
          </div>
          <div class="col-lg-4 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <p>O dialeto paulistano é um dialeto do português brasileiro. É falado na cidade de São Paulo e também na Macrometrópole de São Paulo. Num estudo realizado no âmbito da graduação da Faculdade de Letras da Universidade Federal de Minas Gerais em Belo Horizonte, o dialeto obteve mais de 93% de aprovação dos ouvintes (60 pessoas, em média, ouvidas em cinco estados: Rio Grande do Sul, Santa Catarina, Minas Gerais, Paraná e São Paulo) como a pronúncia "mais correta" do idioma do Brasil, seguido de perto pelo dialeto Gaúcho (90%). O estudo explica a grande aprovação do dialeto por parte dos entrevistados pela sua presença hegemônica nos meios de comunicação.</p>
            <br><p>O dialeto paulistano é conhecido por englobar termos e palavras oriundas dos diversos idiomas falados por seus imigrantes, sendo tais termos inseridos gradualmente no português brasileiro.</p>           
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="voltagemTomada" class="voltagemTomada">
      <div class="container">        
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="img/dicas/voltagem.jpg" class="img-fluid" alt="Foto de uma tomada de 3 pinos">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <p>Em viagens internacionais, é cada vez mais comum levar ao menos o celular e o notebook. Tudo vai bem até chegar a hora de recarregar esses aparelhos. Você olha para a tomada e faz cara de interrogação enquanto segura o plugue. Boa parte do bom humor da viagem vai embora aí. Culpa dos padrões de plugues de tomadas em cada país.</p>
            <br><p>A voltagem padrão da cidade de São Paulo é 110v, porém em todos os lugares sempre tem tomadas 220v (identificadas) caso necessite.</p>
            <br><p>Em vigor desde 2010, as tomadas tipo N são utilizadas apenas no Brasil. São três pinos redondos, sendo dois paralelos e um terceiro no meio e ligeiramente abaixo. Este tipo de tomada não permite o uso de plugues com pinos achatados (tipo A e B). No entanto, é possível usar plugues tipo C mais novos (lançados depois de 2008).</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="documentosNecessarios" class="documentosNecessarios">
      <div class="container">        
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="img/dicas/documentos.jpg" class="img-fluid" alt="Foto de um passaporte brasileiro">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <p>O Brasil adota uma política de concessão de vistos com base no princípio da reciprocidade. Isso significa que nacionais de países que exigem vistos de cidadãos brasileiros para entrada em seus territórios também precisarão de visto para viajar ao Brasil.</p>
            <br><p>Para estrangeiros são necessários:</p>
            <br><p>Passaporte válido (válido por pelo menos mais seis meses no momento da entrada no Brasil). Também é altamente recomendável que o passaporte seja válido por mais de 6 meses no momento da saída.</p>
            <br><p>Prova de alojamento, prova de meios de subsistência para o tempo de permanência no Brasil, bilhete de retorno. Estes documentos podem ser solicitados no momento da entrada no Brasil e a incapacidade de apresentar esses documentos podem, eventualmente, levar às autoridades fronteiriças brasileiras a negar a entrada no país.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="bagagem" class="bagagem">
      <div class="container">        
        ...
        <div class="row">
          <div class="col-lg-8 order-1 order-lg-2">
            <img src="img/dicas/bagagem.jpg" class="img-fluid" alt="Foto de uma pessoa pegando sua mala em um aeroporto">
          </div>
          <div class="col-lg-4 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <p>Compor uma bagagem perfeita pode exigir certa paciência dos viajantes. A mala não deve ser pesada demais (para evitar contratempos no terminal de embarque, por exemplo), mas precisa conter uma série numerosa de itens indispensáveis.</p>
            <br><p>Escolha roupas que combinem entre si, coloque tudo em cima da cama e monte os looks. Não deixe para fazer isso durante a viagem – você perderá tempo e ficará irritada ao perceber que esqueceu aquela camisa que combina com tudo.</p>
            <br><p>Não leve a bagagem lotada. Deixe um lugarzinho para as compras. “Por mais que a intenção seja não comprar, é inevitável trazermos aquele livro do museu que adoramos, ou o casaco quente, fininho e leve que foi um achado.</p>
            <br><p>Um par deve ser muito confortável, apropriado para caminhadas. Dê preferência aos que podem ser usados com meia grossa, tipo Oxford, bota de cano curto ou sapatênis. O outro deve ser social, para ser usado à noite em um jantar, por exemplo.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="comoSeLocomover" class="comoSeLocomover">
      <div class="container">        
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="img/dicas/locomover.jpg" class="img-fluid" alt="Foto de uma estação de metrô de São Paulo">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <p>Para se locomover dentro da cidade de São Paulo, tanto o morador quanto o turista pode utilizar os transportes públicos que, geralmente, são de boa qualidade e com muita frequência.</p>
            <br><p>Existem os horários de pico durante a semana. São os horários que as pessoas saem das áreas periféricas em direção às áreas centrais para trabalhar, ou vice-versa para voltar para casa. Nesses horários os transportes estão abarrotados de gente e o trânsito é caótico.</p>
            <br><p>A oferta de aplicativos de transporte particular, como Uber, 99 táxi e Cabify, é grande e muito fácil de usar praticamente na cidade inteira. Mas você não está tão preocupado em economizar e quer mais conforto? Existe muita oferta de táxi.</p>
          </div>
        </div>
      </div>
    </section>
