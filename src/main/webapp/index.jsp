...
<body>
  ...
  <div class="BrunaPortela">
    ...
    <div class="d-flex justify-content-center mt-4 mb-5">
      <button class="bg-light font-weight-bold border-rounded-pink">Destino aleatório <i
  ...
  <div class="container">
    <h3 class="font-weight-bold">Conheça o Brasil</h3>
  ...
  <div class="container mt-5">
    <h3 class="font-weight-bold">Conheça a Europa</h3>
  ...
  <div class="container mt-5">
    <h3 class="font-weight-bold">Conheça a América do Sul</h3>
